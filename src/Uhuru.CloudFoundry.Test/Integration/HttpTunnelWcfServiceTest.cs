...
namespace Uhuru.CloudFoundry.Test.Integration
{
    ...
    public class HttpTunnelWcfServiceTest
    {
        ...
        {
            password = "!@#33Pass";
            user = Utilities.WindowsVCAPUsers.CreateUser("TunnelTest", password);
        }

        [ClassCleanup]
        public static void ClassCleanup()
        {
            Utilities.WindowsVCAPUsers.DeleteUser("TunnelTest");
        }
        ...
        [TestCategory("Integration")]
        [Timeout(100000)]
        public void TC005_TCPTunnelParallelClientsSend()
        {
            // Arrange
            TunnelPackage.Create(tunnelServiceSourceDir, Path.Combine(tunnelServiceDir, "App"), actualServerPort.ToString(), "127.0.0.1", "Tcp");
        ...
        [TestCategory("Integration")]
        [Timeout(100000)]
        public void TC006_TCPTunnelParallelClientsSendReceive()
        {
            // Arrange
            TunnelPackage.Create(tunnelServiceSourceDir, Path.Combine(tunnelServiceDir, "App"), actualServerPort.ToString(), "127.0.0.1", "Tcp");
        ...
        [TestCategory("Integration")]
        [Timeout(100000)]
        public void TC007_UDPTunnelSimpleSend()
        {
            // Arrange
        ...
        [TestCategory("Integration")]
        [Timeout(100000)]
        public void TC008_UDPTunnelSimpleReceive()
        {
            // Arrange
