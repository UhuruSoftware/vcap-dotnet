// -----------------------------------------------------------------------
// <copyright file="MSSqlErrorException.cs" company="Uhuru Software, Inc.">
...
namespace Uhuru.CloudFoundry.MSSqlService
{
    ...
    /// </summary>
    [Serializable]
    public class MSSqlErrorException : ServiceException
    {
        /// <summary>
        ...
        public MSSqlErrorException(string message)
        ...
        public MSSqlErrorException(string message, Exception innerException)
        ...
        protected MSSqlErrorException(SerializationInfo serializationInfo, StreamingContext streamingContext)
