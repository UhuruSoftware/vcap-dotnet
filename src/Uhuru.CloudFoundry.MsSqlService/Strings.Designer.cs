...
namespace Uhuru.CloudFoundry.MSSqlService {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to SELECT * FROM (SELECT 
        ///	session_id, 
        ///	transaction_id,
        ...
        ///	queries.elapsed &gt;= {0}.
        /// </summary>
        internal static string SqlNodeGetRunningQueries {
            get {
                return ResourceManager.GetString("SqlNodeGetRunningQueries", resourceCulture);
            }
        }
