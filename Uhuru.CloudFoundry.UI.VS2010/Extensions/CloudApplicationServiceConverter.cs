...
{
    internal class CloudApplicationServiceConverter : StringConverter
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            if (standardValues == null)
            {
                ...
                if (client != null)
                {
                    standardValues = new StandardValuesCollection(client.Services().Select(service => service.Vendor).ToArray());
                }
            }
